...
class Config(object):
    ...
    TOKEN = "2027757649:AAHuQg-07RVsldkGTUiuQT3yMp4nYaaZMs8"
    OWNER_ID = "2105971379"
    ...
    DATABASE_URL = "postgres://fnmtwspw:lAwoTHyHbfkAGJJ_BX8rxZw9h7mGtJUF@peanut.db.elephantsql.com/fnmtwspw"  # sql
    LOAD = []
    NO_LOAD = []
    WEBHOOK = False
